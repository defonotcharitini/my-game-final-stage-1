...
function preload(){
  pathImg = loadImage("br.png.png");
  boyImg = loadAnimation("spongebob.png","spongebob copy.png");
  cashImg = loadImage("moneybag.png");
  diamondsImg = loadImage("bottel.png");
  jewelryImg = loadImage("krabbypatty.png");
  swordImg = loadImage("barrel.png");
